...
require(['noext!/setup/apikey', 'moment', 'jquery', 'underscore', 'backbone', 'mustcach', 'nprogress', 'amcharts.serial', 'amcharts.theme.light', 'pageguide', 'jquery.highlight', 'datatables'],
