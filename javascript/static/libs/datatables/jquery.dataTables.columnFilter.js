        ...
        for (columnObjKey in args) {
            if (args.hasOwnProperty(columnObjKey)) {
                ...
                if (filter_container_id === undefined) {
                    ...
                    filter_selector_string = table_selector + " #thead2  th:eq(" + col_num_visible + ")";
                    //console.log(filter_selector_string)
